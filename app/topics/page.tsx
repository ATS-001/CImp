...
import { BookOpen, ChevronRight, Code2, Layers, ArrowLeft, Database } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-xl text-slate-600">
            Select a section to explore the study materials.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600">
              Practice programs, logic questions, and coding challenges for all modules.
            </p>
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div className="mb-10">
        <Link 
          href="/topics"
          className="inline-flex items-center text-slate-500 hover:text-slate-800 mb-6 font-medium transition-colors"
        >
